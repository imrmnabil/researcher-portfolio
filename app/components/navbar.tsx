...
function Navbar({setPageNum = (x)=> {}}: dataFormProps) {
  return (
    <div className='bg-[#0D5748] h-screen w-0 md:w-16 flex flex-col items-center  gap-8'>
            <div className='flex flex-shrink-0 items-center justify-center w-0 md:w-16 h-12 md:h-16 bg-[#116F5C]'>
